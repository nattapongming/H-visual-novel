...
public class DL_SPEAKER_DATA 
{
    ...
    //add () in <> of list can make you store mutliple value in each index
    ...
    public DL_SPEAKER_DATA(string rawSpeaker)
    {
        ...
        //else, seperate speakername from cashing data
        ...
        for (int i = 0;i < matches.Count; i++)
        {
            ...
            else if (match.Value == EXPRESSIONCAST_ID)
            {
                ...
                /*split string into 2 parts then parse first into int for layer
                 and second for expression then return to list
                */
