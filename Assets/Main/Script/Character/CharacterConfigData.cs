...
namespace CHARACTER
{
    ...
    public class CharacterConfigData
    {
        ...
        //alias is a shorter version of character name
        public string alias;
        ...
        //SO will revert to original data every time the game open except in the editor because we make chage to original data 
        //so we make a copy of data instead
